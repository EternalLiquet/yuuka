...
public record EntryResponse(
  ...
  public static EntryResponse from(
    ...
    return new EntryResponse(
        ...
        entry.getPayee(),
        entry.getNotes(),
        entry.getSinkingFundId() == null ? entry.getTargetMinor() : null,
        entry.getSinkingFundId() == null ? entry.getTargetDate() : null,
        entry.getSourceRecurringBillDefinitionId(),
        entry.getSourceRecurringOccurrenceDate(),
        entry.getSourceExpenseLedgerId(),
        spentMinor,
        remainingMinor,
        overBudget,
        entry.getCreatedAt(),
